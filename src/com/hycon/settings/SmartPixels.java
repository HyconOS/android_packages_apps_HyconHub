...
public class SmartPixels extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.den_settings_smart_pixels);

        resolver = getActivity().getContentResolver();

        mSmartPixelsOnPowerSave = (SystemSettingSwitchPreference) findPreference(ENABLE);
            ...
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    if (context.getResources().
                        ...
                        sir.xmlResId = R.xml.den_settings_smart_pixels;
                    }
                    return result;
                }
